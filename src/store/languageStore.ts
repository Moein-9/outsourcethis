    ...
    (set, get) => ({
      ...
      translations: {
        en: {
          ...
          newInvoiceLabel: "New Invoice", // Fixed: Renamed to avoid duplicate property
          ...
          frameDetails: "Frame Details",
          // Fix: Add any missing translation keys here
          ...
          addNewFrameDescription: "Enter the details of the new frame",
          saveFrame: "Save Frame",
          brandExample: "e.g., Ray-Ban",
          modelExample: "e.g., Wayfarer",
          colorExample: "e.g., Black",
          sizeExample: "e.g., 52-18-145",
          ...
          frameAddedSuccessfully: "Frame added successfully: {{brand}} - {{model}}",
          noFramesFound: "No Frames Found",
          noFramesMatchingSearch: "No frames matching your search criteria",
        ...
        ar: {
          ...
          newInvoiceLabel: "فاتورة جديدة", // Fixed: Renamed to avoid duplicate property
          searchInstructions: "أدخل اسم العميل أو رقم الفاتورة أو رقم الهاتف",
          selectTransaction: "اختر معاملة لمعالجة الاسترداد",
          transactionDetails: "تفاصيل المعاملة",
          frameDetails: "تفاصيل الإطار",
          // Fix: Add any missing Arabic translation keys here
          ...
          brandExample: "مثال: راي-بان",
          modelExample: "مثال: وايفرر",
          colorExample: "مثال: أسود",
          sizeExample: "مثال: 52-18-145",
          ...
          frameAddedSuccessfully: "تمت إضافة الإطار بنجاح: {{brand}} - {{model}}",
          noFramesFound: "لم يتم العثور على إطارات",
          noFramesMatchingSearch: "لا توجد إطارات تطابق معايير البحث الخاصة بك",
