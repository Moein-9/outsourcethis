              ...
              <div className="flex justify-between items-start">
                <div className="space-y-3 flex-1">
                  <div className="flex items-center gap-1.5">
                    ...
                    {/* Edit Status - New */}
                    {hasBeenEdited && (
                      <Badge variant="outline" className="bg-violet-50 text-violet-700 border-violet-200 ml-2 flex items-center gap-1">
                  ...
                  {hasBeenEdited && editTimeAgo && (
                    <div className="text-xs text-violet-600 flex items-center gap-1 mt-0.5 mb-1">
                      <History className="h-3 w-3" />
                      {language === 'ar' ? `تم التعديل ${editTimeAgo}` : `Edited ${editTimeAgo}`}
                    </div>
                  )}
              ...
              <div className="flex justify-between items-start">
                <div className="space-y-3 flex-1">
                  ...
                  {hasBeenEdited && (
                    <div className="text-xs text-violet-600 flex items-center gap-1 mt-0.5 mb-1">
                      <History className="h-3 w-3" />
                      {language === 'ar' ? `تم التعديل ${getTimeAgo(invoice.lastEditedAt)}` : `Edited ${getTimeAgo(invoice.lastEditedAt)}`}
                    </div>
                  )}
                ...
                <div className="space-y-3 flex-1">
                  ...
                  {invoice.refundDate && (
                    <div className="text-xs text-red-600 flex items-center gap-1 mt-0.5">
                      <Calendar className="h-3 w-3" />
                      {language === 'ar' ? "تاريخ الاسترداد:" : "Refund date:"} {formatDate(invoice.refundDate)}
                    </div>
                  )}
