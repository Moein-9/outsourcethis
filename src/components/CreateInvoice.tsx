...
import { 
  FileText, Printer, Receipt, User, PackageCheck, CreditCard, Check,
...
const CreateInvoiceContent: React.FC = () => {
  ...
  // Watch for workOrderId and invoiceId changes to auto-navigate to summary
  useEffect(() => {
