...
export const LensThicknessManager: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<string>("distance_reading");
  ...
  const [newThicknessCategory, setNewThicknessCategory] = useState<"distance_reading" | "progressive" | "bifocal">("distance_reading");
  ...
  const [editThicknessCategory, setEditThicknessCategory] = useState<"distance_reading" | "progressive" | "bifocal">("distance_reading");
  ...
  const categoryOptions = [
    { value: "distance_reading", label: t("distanceReading") || "Distance/Reading" },
  ...
  return (
    <div className="space-y-4">
        ...
        <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
          ...
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                {t("addNewThicknessDescription") || "Add a new lens thickness option to your inventory."}
              </DialogDescription>
            </DialogHeader>
            <div className="grid gap-4 py-4">
              <div className="grid gap-2">
                ...
                <Input
                  ...
                  placeholder={t("thicknessNameExample") || "e.g., Standard, Slim, Ultra-thin"}
                />
              </div>
              <div className="grid gap-2">
              ...
              <div className="grid gap-2">
                ...
                <Select value={newThicknessCategory} onValueChange={(value) => setNewThicknessCategory(value as any)}>
      ...
      <Tabs defaultValue="distance_reading" value={activeTab} onValueChange={setActiveTab}>
        <TabsList className="grid grid-cols-3 mb-4">
          <TabsTrigger value="distance_reading">{t("distanceReading") || "Distance/Reading"}</TabsTrigger>
        ...
        <TabsContent value={activeTab} className="mt-0">
          {filteredThicknesses.length > 0 ? (
            ...
            <div className="text-center p-8 bg-muted/50 rounded-lg">
              <p>{t("noThicknessesInCategory") || "No thickness options in this category"}</p>
        ...
        <DialogContent>
          ...
          <div className="grid gap-4 py-4">
            ...
            <div className="grid gap-2">
              ...
              <Select value={editThicknessCategory} onValueChange={(value) => setEditThicknessCategory(value as any)}>
